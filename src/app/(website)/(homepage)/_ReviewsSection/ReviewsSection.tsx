        ...
        <section className='relative mb-24 space-y-14 overflow-x-hidden laptop:space-y-28'>
            <div className='space-y-5'>
                ...
                <p className='mb-28 text-center'>
                    Odkryj, co nasi pacjenci mówią o naszym podejściu i dlaczego
                    warto nam zaufać. Dołącz do grona zadowolonych użytkowników
                    i ciesz się kompleksową opieką zdrowotną na jaką
                    zasługujesz.
                </p>
            </div>
